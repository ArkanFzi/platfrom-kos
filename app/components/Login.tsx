...
export function Login({ onLoginAsAdmin, onLoginAsUser, onLoginAsGuest }: LoginProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      onLoginAsUser(); // Default to user login for Google
    }, 500);
  };
    ...
    <div className="flex h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <div className="hidden md:flex md:w-[55%] flex-col items-center justify-center p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h1 className="text-6xl font-bold mb-4 text-white drop-shadow-lg">LuxeStay</h1>
          <p className="text-2xl text-amber-200 mb-6 drop-shadow-md font-semibold">
          ...
          <div className="space-y-4 mt-12">
            <div className="flex items-center gap-3 text-slate-200">
              ...
              <span>Premium rooms with modern amenities</span>
            </div>
            <div className="flex items-center gap-3 text-slate-200">
              <div className="w-2 h-2 bg-amber-400 rounded-full" />
              <span>Easy booking and payment system</span>
            </div>
            <div className="flex items-center gap-3 text-slate-200">
              <div className="w-2 h-2 bg-amber-400 rounded-full" />
              <span>Transparent tenant management</span>
            </div>
          </div>
        </div>
      </div>
