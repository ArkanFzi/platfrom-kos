...
// import Slider from 'react-slick'; // Removed - use simple carousel
import { 
  Search, 
  MapPin, 
  Wifi, 
...
export function Homepage({ onRoomClick }: HomepageProps) {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-900 via-stone-800 to-slate-900 text-white py-24 overflow-hidden">
        {/* Animated background */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            <Card className="bg-white/10 backdrop-blur-2xl border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-shadow">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-12 bg-white/90 backdrop-blur-sm border-white/30 focus:border-white/50 text-slate-900 placeholder:text-slate-500 transition-all"
                    />
                  </div>
                </div>
                <div>
              ...
              <Button className="w-full md:w-auto mt-6 bg-gradient-to-r from-stone-700 to-stone-800 hover:from-stone-600 hover:to-stone-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all px-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div>
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-slate-900 mb-4">Featured Rooms</h2>
                  ...
                  <Card className="bg-white shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group cursor-pointer border-0 h-full flex flex-col">
                    ...
                    <div className="relative h-72 overflow-hidden bg-gradient-to-br from-slate-200 to-slate-300">
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge className="bg-gradient-to-r from-stone-700 to-stone-900 text-white border-0 shadow-lg">
                          {room.type}
                        </Badge>
                      </div>
                      {/* Location Overlay */}
      ...
      {/* Why Choose Us */}
      <section className="bg-gradient-to-br from-slate-50 via-white to-stone-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold text-slate-900 mb-4">Why Choose LuxeStay?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} className={`bg-gradient-to-br ${feature.color} border p-8 text-center hover:shadow-xl transition-all duration-300`}>
